...
```json
{
    ...
    "discord": {
        ...
        "smallImageText": "koloksk",
        "smallImageKey": "seal-circle"
    },
    "rss": "https://koloksk.com/articles/index.rss",
    "servers": [
        {
            "id": "Example_Server",
            "name": "koloksk Example Client",
            "description": "Example koloksk server. Connect for fun!",
            "icon": "http://mc.koloksk.com/kolokskLauncher/files/example_icon.png",
            "version": "0.0.1",
            "address": "mc.koloksk.com:1337",
            "minecraftVersion": "1.11.2",
            "discord": {
                "shortId": "Example",
                "largeImageText": "koloksk Example Server",
    ...
    "subModules": [
        {
            ...
            "artifact": {
                ...
                "url": "http://mc.koloksk.com/kolokskLauncher/files/1.11.2/launchwrapper-1.12.jar"
            }
        }
    ]
}
...
```json
{
    ...
    "artifact": {
        ...
        "url": "http://mc.koloksk.com/kolokskLauncher/files/1.11.2/liteloader-1.11.2.jar"
    },
    "subModules": [
...
```json
{
    ...
    "artifact": {
        ...
        "url": "http://mc.koloksk.com/kolokskLauncher/files/1.11.2/jopt-simple-4.6.jar"
    }
}
```
...
The module type `ForgeMod` represents a mod loaded by the Forge Mod Loader (FML). These files are stored maven-style and passed to FML using forge's [Modlist format](https://github1.com/MinecraftForge/FML/wiki/New-JSON-Modlist-format).

Ex.
```json
{
    "id": "com.koloksk:westerosblocks:3.0.0-beta-6-133",
    "name": "WesterosBlocks (3.0.0-beta-6-133)",
    "type": "ForgeMod",
    "artifact": {
        "size": 16321712,
        "MD5": "5a89e2ab18916c18965fc93a0766cc6e",
        "url": "http://mc.koloksk.com/kolokskLauncher/prod-1.11.2/mods/WesterosBlocks.jar"
    }
}
```
...
The module type `LiteMod` represents a mod loaded by liteloader. These files are stored maven-style and passed to liteloader using forge's [Modlist format](https://github1.com/MinecraftForge/FML/wiki/New-JSON-Modlist-format). Documentation for liteloader's implementation of this can be found on [this issue](http://develop.liteloader.com/liteloader/LiteLoader/issues/34).
...
```json
{
    ...
    "artifact": {
        ...
        "url": "http://mc.koloksk.com/kolokskLauncher/prod-1.11.2/mods/macrokeybindmod.litemod"
    }
}
```
...
```json
{
    "id": "com.koloksk:kolokskrp:2017-08-16",
    "name": "koloksk Resource Pack (2017-08-16)",
    "type": "file",
     "artifact": {
        "size": 45241339,
        "MD5": "ec2d9fdb14d5c2eafe5975a240202f1a",
        "path": "resourcepacks/koloksk.zip",
        "url": "http://mc.koloksk.com/kolokskLauncher/prod-1.11.2/resourcepacks/koloksk.zip"
    }
}
```
